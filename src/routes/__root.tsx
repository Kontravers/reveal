  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Drop-in cursor vignette that reveals Bayer-dithered or live-color video. Tune radius, grade, and copy the snippet.",
      },
      { name: "theme-color", content: "#e8e2d4" },
    ],
    links: [
